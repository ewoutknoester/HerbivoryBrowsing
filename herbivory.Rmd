...
Data info:
  ...
  After correction with Weight_contorl, grazing > 100 was set to 100 and grazing < 0 was set to 0
...
ggsave("Grazing Both (Location).tiff", width = 23, height = 11, units = "cm", dpi=1200, compression = "lzw")
