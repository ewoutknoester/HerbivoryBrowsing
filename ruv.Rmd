...
Data info:
  ...
  Bites standardized to weight and time (bites * gram / minute)
-->
...
ggplot(ruv.1, aes(fill = Macroalgae, y = smsBites, x = reorder(Species, -Bites_max))) + 
  ...
  theme(
    ...
    axis.text.x = element_text(color="black", size = 12, face = "bold.italic", angle = -35,  hjust=0, vjust = 1),
    ...
    plot.margin = margin(t = 10, r = 40,  b = 0,  l = 20),
